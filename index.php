...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="icon" href="/favicons/favicon.png" type="image/png" sizes="64x64" />
		<link rel="icon" href="/favicon.ico" type="image/x-icon" />

		<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Roboto+Slab:400,700" media="all" />
		<link rel="stylesheet" type="text/css" href="css/a11y-above.min.css" media="all" />
			...
			<section>
				...
				<div class="left content">
					...
					<address class="h-card icons-tollwerk" itemscope="itemscope" itemtype="http://data-vocabulary.org/Organization" id="tollwerk">
						...
						<dl>
							<dt>Internet</dt>
							<dd><a href="http://tollwerk.de" target="_blank" class="u-url" itemprop="url">http://tollwerk.de</a></dd>
							<dt>E-Mail</dt>
